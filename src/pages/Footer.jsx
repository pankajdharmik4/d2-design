      ...
      <div className="">
        ...
        <div className="flex flex-col md:flex-row bg-[#13192d] px-[10%] justify-between items-center border-t border-gray-700 py-4">
          ...
          <div className="flex space-x-4">
            <a href="#" className="text-white hover:text-white font-montserrat text-sm pr-2">Privacy Policy</a>
            <a href="#" className="text-white hover:text-white font-montserrat text-sm">Terms and Conditions</a>
          </div>
        </div>
      </div>
    </footer>
