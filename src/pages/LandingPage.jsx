...
export function LandingPage() {
  return <div id="home" className="relative w-full h-full md:mb-2 bg-repeat bg-center bg-[#261FB3]">
    <div className="relative w-full h-auto md:h-[530px] lg:h-[600px] flex flex-col-reverse md:flex-row">
      {/* Section 1: Text */}
      <div className="flex flex-col mb-7 items-center justify-center w-full lg:w-1/2 md:p-10 p-2 text-white">
        ...
        <button className="bg-white text-sm md:text-sm lg:text-xl text-[#261FB3] font-bold mt-1 py-3 md:py-3 px-4 md:px-6 rounded-lg font-lato text-left lg:self-start lg:mx-[10%] md:mb-0 mb-[10%]">
