...
const Hero = ({ openModal }) => {
  ...
  return (
    <div className="relative w-full h-full md:mb-2 bg-repeat bg-center bg-[#3A59D1]">
      <div className="relative w-full h-auto md:h-[500px] lg:h-[600px] flex flex-col-reverse md:flex-row bg-[#3A59D1]">
        {/* Section 1: Text */}
        <div className="flex flex-col mb-10 items-center justify-center w-full lg:w-1/2 md:p-10 p-2 text-white">
          ...
          <button onClick={openModal} className="bg-white text-sm md:text-sm lg:text-xl text-[#3A59D1] font-bold py-2 md:py-3 px-4 md:px-6 rounded-lg font-lato text-left lg:self-start lg:mx-[10%] md:mb-0 mb-[10%]">
