    ...
    <div id="home" className="relative w-full h-full md:mb-2 bg-repeat bg-center" style={{ backgroundImage: "url('/images/bg-img.png')" }}>
      <div className="relative w-full h-auto md:h-[500px] lg:h-[600px] flex flex-col-reverse md:flex-row">
        ...
        <div className="flex flex-col mb-10 items-center justify-center w-full lg:w-1/2 md:p-10 p-2 text-white">
          ...
          <p className="text-xs md:text-md mb-3 text-center lg:text-left mx-[10%] md:my-0 my-[5%] font-montserrat font-normal">
          ...
          <p className="hidden md:block text-xs md:text-md mb-8 text-center lg:text-left mx-[10%] font-montserrat font-normal"> 
          ...
          <button onClick={openModal} className="bg-white text-xs md:text-sm lg:text-xl text-[#13192D] font-bold py-2 md:py-3 px-4 md:px-6 rounded-lg font-lato text-left lg:self-start lg:mx-[10%] md:mb-0 mb-[10%]">
